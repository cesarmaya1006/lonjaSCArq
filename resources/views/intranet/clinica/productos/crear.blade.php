...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Tiempos - Crear</li>
@endsection

@section('titulo_card')
    <i class="fa fa-plus-square mr-3" aria-hidden="true"></i> Crear Productos / Servicios
@endsection
...
<div class="row d-flex justify-content-center">
    <form class="col-12 form-horizontal" action="{{ route('productos.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
        @csrf
        @method('post')
...
<script src="{{ asset('js/intranet/configuracion/tiempos/crear.js') }}"></script>
@endsection
