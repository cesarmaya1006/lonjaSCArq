...
@section('titulo_pagina')
    <i class="fas fa-hospital-symbol mr-3" aria-hidden="true"></i> Configuración Clínicas
@endsection
...
@section('titulo_card')
    <i class="fa fa-plus-square mr-3" aria-hidden="true"></i> Nueva Clínica
@endsection
...
@section('cuerpo')
    <div class="row d-flex justify-content-center">
        <form class="col-12 form-horizontal" action="{{ route('clinicas.store') }}" method="POST" autocomplete="off"
...
<script src="{{asset('js/intranet/empresa/clinica/crear.js')}}"></script>
@endsection
